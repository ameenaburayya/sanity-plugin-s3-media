...
import { Card, Flex, Inline, Text, Button, Stack, Code } from '@sanity/ui';
import { LinearProgress, Translate, useTranslation } from 'sanity';
import styled from 'styled-components';
import { STALE_UPLOAD_MS } from '../../constants';
import { RatioBox } from './RatioBox';

const CardWrapper = styled(RatioBox)`
...
export function UploadProgress({ uploadState, onCancel, onStale }: Props) {
  ...
  return (
    <CardWrapper tone='primary' border>
      <FlexWrapper padding={4} align='center' justify='space-between' height='fill' direction='row' gap={2}>
        <LeftSection>
