import React, { type CSSProperties, type FocusEvent, useCallback, useMemo } from 'react';
...
export const S3ImageInputAsset = (props: {
  ...
  const handleSelectFile = useCallback(
    ({ file }: Omit<InputOnSelectFileFunctionProps, 'assetSource'>) => {
      onSelectFile(file);
    },
    [onSelectFile]
  );
