...
type ReferringDocumentProps = {doc: SanityDocument; schemaType?: SchemaType}

const ReferringDocument: FC<ReferringDocumentProps> = (props) => {
...
export const DocumentList: FC<DocumentListProps> = ({documents, isLoading}) => {
