...
class S3Uploader implements AssetSourceUploader {
  ...
  public constructor(props: CreateS3AssetSourceProps) {
    this.sanityClient = props.sanityClient
      ...
      if (uploader) {
        this.subscriptions.set(
          ...
          uploader
            .upload({
              file,
              sanityClient: this.sanityClient,
...
export function createS3Uploader(props: CreateS3AssetSourceProps): AssetSourceUploaderClass {
  return class S3AssetSourceUploader extends S3Uploader {
    constructor() {
      super(props)
    }
  }
